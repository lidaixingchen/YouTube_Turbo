...
export const DICTIONARIES: Record<string, LocaleDictionary> = {
  "en": {
    ...
    messages: {
      ...
      feature_speed_control_desc: "Support seamless speed adjustment with keyboard shortcuts and a player menu.",
  ...
  "zh-CN": {
    ...
    messages: {
      ...
      feature_speed_control_desc: "支持键盘快捷键无级调速与独立播放器调速菜单",
  ...
  "zh-TW": {
    ...
    messages: {
      ...
      feature_speed_control_desc: "支援鍵盤快速鍵無級調速與獨立播放器調速選單",
  ...
  "ja": {
    ...
    messages: {
      ...
      feature_speed_control_desc: "ショートカットキーによる速度調整と独立した速度メニューを提供します",
